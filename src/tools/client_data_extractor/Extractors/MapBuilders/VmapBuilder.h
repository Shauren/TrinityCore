...
#ifndef VmapBuilder_h__
#define VmapBuilder_h__

#include "MapDataExtractor.h"

namespace Trinity
{
    class VmapBuilder : public MapDataExtractor::BaseBuilder
    {
    public:
        VmapBuilder(boost::filesystem::path outputPath, bool includeAllVmapVertices)
            : MapDataExtractor::BaseBuilder(std::move(outputPath)), _includeAllVmapVertices(includeAllVmapVertices) { }
